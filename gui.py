...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("icons/now.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_icon.setPixmap(QtGui.QPixmap("icons/now.ico"))
        ...
        self.label_info_icon.setPixmap(QtGui.QPixmap("icons/info.ico"))
